...
int BoardInitializeFalse()
{
  return -1;
}

int BoardInitializeTrue()
{
  return 1;
}
...
TEST(Embedded, bigPwmBoardInitializeFalse)
{
  initializeServomoteurSplit(BoardInitializeFalse, startTrue);
   CHECK_EQUAL(-1,Servomoteur(80));
}

TEST(Embedded, bigPwmBoardInitializeTrue)
{
  initializeServomoteurSplit(BoardInitializeTrue, startTrue);
   CHECK_EQUAL(0,Servomoteur(80));
}

TEST(Embedded, bigPwmBoardInitializeTrueFalse)
{
  initializeServomoteurSplit(BoardInitializeTrue, startFalse);
   CHECK_EQUAL(-2,Servomoteur(80));
}
